...
<head>
    ...
    <!-- Preload icons -->
    <link rel="preload" href="assets/themes/<?php echo $settings['theme'] ?>/mecwbjnp.json">
    <link rel="preload" href="assets/themes/<?php echo $settings['theme'] ?>/lupuorrc.json">
    <link rel="preload" href="assets/themes/<?php echo $settings['theme'] ?>/yyecauzv.json">
